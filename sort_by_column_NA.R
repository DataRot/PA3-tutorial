...
## SuppressWarnings() stops the warning alerts from R. When we coerce a mixed list of 
## numeric and character into a numeric vector, text becomes automatically NA,
## but it's a forced coercion and R sends a warning. This is the case of our column 3 and 4,
## where "Unknown" becomes NA.
##
## complete.cases() returns the indexes of the rows that don't have any NA.
## By subsetting the matrix by these indexes we get a data frame with only complete cases.
